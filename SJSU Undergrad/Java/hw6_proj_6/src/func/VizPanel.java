...
public class VizPanel extends JPanel {
	// Static constants are the only variables that should start with a capital
	// letter. In fact,
	// they should be in all capitals. I line up the declarations, names, and
	// equals-signs.
	...
	// This is a static initializer. It executes once, when the JVM loads the class,
	// before any
	...
	// For instance variables, I line up the declarations and also the variable
	// names.
